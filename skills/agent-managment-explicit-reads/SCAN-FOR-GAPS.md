---
name: scan-for-gaps
description: Read this skill after validate-promised PASSes. Convenience lens — walk through 2-3 realistic user tasks mentally, surface missing affordances the plan didn't enumerate, then return a list (not yes/no) for approval. Catches things the plan didn't think to ask for that the user clearly wants.
---
