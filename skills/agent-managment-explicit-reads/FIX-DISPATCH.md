---
name: fix-dispatch
description: Read this skill when a validation phase (validate-promised or aesthetic-pass) returns FAIL with issues. Decide whether to bundle small issues or dispatch immediately, brief the developer agent using the file-not-paste pattern, and re-enter the validation phase after fix is reported done.
---
