---
name: aesthetic-pass
description: Use after all functional validation passes (validate-promised + any approved gap features), to apply an aesthetic critique before declaring the round done. Compare screenshots against production tools (Linear, Vercel, Figma, Stripe), check the smell list, identify wireframe-y patterns. Output: PASS or FAIL with location-specific issues. Don't bundle these with bug fixes.
---
